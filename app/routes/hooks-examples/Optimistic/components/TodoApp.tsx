import { startTransition, useOptimistic, useRef, useState, type FormEvent } from 'react';
import { createTodo, type Todo } from '../api';
import { todoReducer, type OptimisticTodo } from '../utils/todoReducer';
    ...
    return (
        <>
            <form onSubmit={onSubmit}>
                <label>title:</label>
                <br />
                <input ref={inputRef} placeholder="write a todo..." required autoFocus />
                <br />
